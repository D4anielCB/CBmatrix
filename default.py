...
def Update():
	Path = xbmc.translatePath( xbmcaddon.Addon().getAddonInfo('path') ).decode("utf-8")
	try:
		fonte = OpenURL( "https://raw.githubusercontent.com/D4anielCB/CB/master/default.py" )
		...
		if prog:
			...
			file.write(fonte)
			file.close()
		fonte = OpenURL( "https://raw.githubusercontent.com/D4anielCB/CB/master/resources/settings.xml" )
		...
		if prog:
			...
			file.write(fonte)
			file.close()
		fonte = OpenURL( "https://raw.githubusercontent.com/D4anielCB/CB/master/addon.xml" )
